...
class CalendarViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        calendarData = [
            CalendarStruct(cMonth: "March", cYear: "2020", cDay: "20", cColor: "blue"),
            CalendarStruct(cMonth: "March", cYear: "2020", cDay: "25", cColor: "red"),
            CalendarStruct(cMonth: "April", cYear: "2020", cDay: "2", cColor:  "green"),
            CalendarStruct(cMonth: "April", cYear: "2020", cDay: "14", cColor: ""),
            CalendarStruct(cMonth: "April", cYear: "2020", cDay: "16", cColor: "purple")
        ]
    ...
    func loadData() {
        if let data = UserDefaults.standard.value(forKey:"saveData") as? Data {
            ...
            calendarData = data ?? [CalendarStruct(cMonth: "", cYear: "", cDay: "", cColor: "")]
            print(calendarData)
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
      ...
      //r  cell.CellView.backgroundColor = setColor(color: calendarData[indexPath.row].cColor)
